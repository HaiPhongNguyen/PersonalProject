...
#define SP4_Pin GPIO_PIN_15
#define SP4_GPIO_Port GPIOB
#define SP3_Pin GPIO_PIN_8
#define SP3_GPIO_Port GPIOA
#define SP2_Pin GPIO_PIN_3
#define SP2_GPIO_Port GPIOB
#define SP1_Pin GPIO_PIN_4
#define SP1_GPIO_Port GPIOB
#define SIV_Pin GPIO_PIN_5
#define SIV_GPIO_Port GPIOB
